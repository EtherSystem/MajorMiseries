...
{
    internal class SevereAnkleSprainRisk
    {
        public class SevereAnkleSprainRiskAffliction : CustomAffliction, IRemedies, IInstance, IRiskPercentage, ILocalizableAffliction
        {
            private const string NAME_KEY = "GAMEPLAY_SevereAnkleSprainRiskName";
            ...
            {
                if (existingAffliction is SevereAnkleSprainRiskAffliction ankleRisk)
                {
                    ankleRisk.UpdateRiskValue();
                    ankleRisk.ResetAffliction(resetRemedies: true);
                }
            }
            ...
            public void RefreshLocalization()
            {
                ...
                Core.Log($"SevereAnkleSprainRisk refresh -> '{oldName}' => '{m_Name}'");
            }
        }
    }
}
