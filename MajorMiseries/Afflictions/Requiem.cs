...
namespace MajorMiseries.Afflictions
{
    internal class Requiem
    {
        public class RequiemAffliction : CustomAffliction, IDuration, IRemedies, IInstance, ILocalizableAffliction
        {
            ...
            //public RequiemAffliction(AfflictionBodyArea bodyArea) : base(NAME_KEY, CAUSE_KEY, DESC_KEY, null, "Major_Miseries.Resources.Icons.Afflictions.Requiem.png", bodyArea, true)
